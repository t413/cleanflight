...
static void resetPidProfile(pidProfile_t *pidProfile)
{
    ...
    pidProfile->I8[PIDALT] = 30;
    pidProfile->D8[PIDALT] = 80;
    pidProfile->P8[PIDPOS] = 10;    // POSHOLD_P * 100;
    pidProfile->I8[PIDPOS] = 3;     // POSHOLD_I * 100;
    pidProfile->D8[PIDPOS] = 0;
    pidProfile->P8[PIDPOSR] = 140;  // POSHOLD_RATE_P * 10;
    pidProfile->I8[PIDPOSR] = 0;    // POSHOLD_RATE_I * 100;
    pidProfile->D8[PIDPOSR] = 100;  // POSHOLD_RATE_D * 1000;
    pidProfile->P8[PIDNAVR] = 140;  // NAV_P * 10;
    pidProfile->I8[PIDNAVR] = 50;   // NAV_I * 100;
    pidProfile->D8[PIDNAVR] = 100;  // NAV_D * 1000;
